...
brawlhalla7 = Brawlhalla(personagens='Hattori', preco=2300, forca=4, defesa=4, destreza=6, agilidade=8, armaum='Espada', armadois='Lança')
...
brawlhalla15 = Brawlhalla(personagens='Brynn', preco=900, forca=5, defesa=5, destreza=5, agilidade=7, armaum='Machado', armadois='Lança')
...
brawlhalla39 = Brawlhalla(personagens='jiro', preco=5400, forca=5, defesa=3, destreza=7, agilidade=7, armaum='Espada', armadois='Foice')
...
brawlhalla46 = Brawlhalla(personagens='Petra', preco=5400, forca=8, defesa=4, destreza=4, agilidade=6, armaum='Luva', armadois='Orbe')
...
brawlhalla52 = Brawlhalla(personagens='magyar', preco=5400, forca=5, defesa=9, destreza=4, agilidade=4, armaum='Martelo', armadois='Espadão')
